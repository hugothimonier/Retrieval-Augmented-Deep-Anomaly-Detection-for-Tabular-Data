...
mkdir -p ./logs/forest_cover
mkdir -p ./results/forest_cover
mkdir -p ./tblogs/forest_cover
...
python -u run.py \
    ...
    --model_dim_hidden 16 \
    --model_num_heads_e 4 \
    --model_num_layers_e 4 > ./logs/forest/forest_transformer_None.log